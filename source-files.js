...
sourcesIndex["corundum"] = {"name":"","dirs":[{"name":"alloc","dirs":[{"name":"alg","files":["buddy.rs","libpmem.rs","mod.rs"]}],"files":["heap.rs","mod.rs","pool.rs"]},{"name":"cell","files":["cell.rs","mod.rs","refcell.rs","rootcell.rs","vcell.rs"]},{"name":"ptr","files":["fatptr.rs","mod.rs","non_null.rs","ptr.rs"]},{"name":"stm","files":["chaperon.rs","journal.rs","log.rs","mod.rs"]},{"name":"sync","files":["mod.rs","mutex.rs","parc.rs"]}],"files":["boxed.rs","clone.rs","convert.rs","lib.rs","ll.rs","marker.rs","prc.rs","stat.rs","str.rs","tests.rs","utils.rs","vec.rs"]};
